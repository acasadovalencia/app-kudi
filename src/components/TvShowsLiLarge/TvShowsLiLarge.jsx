    ...
    return(
        ...
        <li className="Section-li Tvshows-li">
            ...
            <picture className="Section-picture Tvshows-picture">
                ...
                <img src={`/assets/images/${poster.large}.jpg`} alt={title} className="Section-img Tvshows-picture" loading='lazy' width='280' height='150' />
            </picture>
            <div className="Description-wrapper">
                <PlayBtn/>
                <div className="Title-wrapper">
                    <h3 className="Tvshows-h3">{title}</h3>
                ...
                <span className="Tvshows-span">{runtime} min</span>
                <p className="Tvshows-paragraph">{description}</p>
            </div>
            </NavLink>
        </li>
        </>
