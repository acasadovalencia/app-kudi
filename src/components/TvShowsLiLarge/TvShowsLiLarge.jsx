...
export const TvShowsLiLarge = (props)=>{

    const {_id , title , description , runtime , rating , poster} = props

    return(
        <>
        <li className="Section-li MoviesLarge-li">
            ...
            <picture className="Section-picture MoviesLarge-picture">
                ...
                <img src={`/assets/images/${poster.large}.jpg`} alt={title} className="Section-img MoviesLarge-picture" loading='lazy' width='280' height='150' />
            </picture>
            <div className="Description-wrapper">
                <PlayBtn/>
                <div className="Title-wrapper">
                    <h3 className="MoviesLarge-h3">{title}</h3>
                ...
                <span className="MoviesLarge-span">{runtime} min</span>
                <p className="MoviesLarge-paragraph">{description}</p>
            </div>
            </NavLink>
        </li>
        </>
