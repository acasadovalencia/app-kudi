    ...
    return(
        ...
        <article className="Article Movie">
            <div className="Article-wrapper">
                <h2 className="Article-h2 H2">{movie && movie.title}</h2>
                <div className="Span-wrapper">
                    <span className="Article-span">{movie && movie.pegi}</span>
                    <div className="Rate-wrapper">
                        ...
                        <span className="Article-span">{movie && movie.rating}</span>                   
                    </div>
                    <span className="Article-span">{movie && movie.runtime} min</span>
                </div>
                <p className="Article-paragraph">{movie && movie.description}</p>
